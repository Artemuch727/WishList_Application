      ...
      <div className={s.root}>
        <div className={s.container}>
          ...
          <ul>
            ...
            <li>Количество записей в листе отображается в панели выбора</li>
            <li>Возможность редактировать описание к записи</li>
            <li>Алерт при добавлении нового списка</li>
          </ul>
        </div>
      </div>
    );
